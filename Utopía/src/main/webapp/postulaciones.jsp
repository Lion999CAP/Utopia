...
<body>
  ...
  <main>
    <h1>Bienvenido, espera mientras el administrador acepta tu solicitud</h1>
    <h2>Conocer más acerca de Utopía</h2>
    
    <ul>
      <li><a href="https://utopia.ups.edu.ec/"> Nuestra revista universitaria </a></li>
      <li><a href="https://www.ups.edu.ec/club-utopia-uio"> Más informacion acerca de nosotros </a></li>
    </ul>
